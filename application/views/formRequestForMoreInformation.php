                        ...
                        <table>
                            <tr>
                                <td class="px-2">
                                    ...
                                    <select name="up_project_code" id="up_project_code" class="form-select" aria-label="Default select example" style="width: 150px;" <?php if ($training_request_datas->workflow_remark == "Requested More Information by Reviewer" || $training_request_datas->workflow_remark == "Requested More Information by Approver") echo "disabled"; ?>>
                                        <option value="" class="mit">- Select -</option>
                        ...
                        <table>
                            <tr>
                                <td class="px-2">
                                    ...
                                    <select name="up_cost_code" id="up_cost_code" class="form-select" aria-label="Default select example" style="width: 150px;" <?php if ($training_request_datas->workflow_remark == "Requested More Information by Reviewer" || $training_request_datas->workflow_remark == "Requested More Information by Approver") echo "disabled"; ?>>
                                        <option value="" class="mit">- Select -</option>
