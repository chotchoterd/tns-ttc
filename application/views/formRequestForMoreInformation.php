...
include 'scriptFormRequestForMoreInformation.php';
?>
<div class="container-fluid mt-3">
    <form action="" method="post" id="up-data-form" enctype="multipart/form-data">
        <div class="text-center mb-3">
            <button type="submit" id="up_bt_submit" name="up_bt_submit" class="btn btn-primary btn_color_df">Re-Submit</button>
        </div>
        <table class="table table-form border">
            <?php foreach ($training_request_data as $training_request_datas) { ?>
                ...
                <tr class="mit">
                    <th rowspan="5" colspan="5" style="font-size: 40px;" class="border">
                        <?php if ($training_request_datas->workflow_remark == "Requested More Information by Admin") { ?>
                            Training Request<br>(Requested More Information by Admin)
                        <?php } else if ($training_request_datas->workflow_remark == "Requested More Information by Reviewer") { ?>
                            Training Request<br>(Requested More Information by Reviewer)
                        <?php } else { ?>
                            Training Request<br>(Requested More Information by Approver)
                        <?php } ?>
                    </th>
                </tr>
                <tr>
                        ...
                        <table>
                            <tr>
                                <td class="px-2">
                                    ...
                                    <select name="up_section_code" id="up_section_code" class="form-select" aria-label="Default select example" <?php if ($training_request_datas->workflow_remark == "Requested More Information by Reviewer" || $training_request_datas->workflow_remark == "Requested More Information by Approver") echo "disabled"; ?>>
                        ...
                        <table>
                            <tr>
                                <td class="px-2">
                                    ...
                                    <select name="up_project_code" id="up_project_code" class="form-select" aria-label="Default select example" style="width: 250px;" <?php if ($training_request_datas->workflow_remark == "Requested More Information by Reviewer" || $training_request_datas->workflow_remark == "Requested More Information by Approver") echo "disabled"; ?>>
                                        <option value="" class="mit">- Select -</option>
                        ...
                        <table>
                            <tr>
                                <td class="px-2">
                                    ...
                                    <select name="up_cost_code" id="up_cost_code" class="form-select" aria-label="Default select example" style="width: 250px;" <?php if ($training_request_datas->workflow_remark == "Requested More Information by Reviewer" || $training_request_datas->workflow_remark == "Requested More Information by Approver") echo "disabled"; ?>>
                                        <option value="" class="mit">- Select -</option>
                ...
                <!-- <tr>
                    ...
                    <th colspan="6" class="form_request_head_yellow ">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-11"><input type="text" name="up_online_location_date" id="up_online_location_date" class="form-control mb-2" <?php if ($training_request_datas->online_location_date == "") { ?> style="display: none;" <?php } ?> value="<?php echo $training_request_datas->online_location_date ?>" placeholder="Details for Online (if known)"></div>
                        </div>
                        <div class="row">
                            <div class="col-sm-1">
                                <input type="checkbox" name="up_platform[]" id="up_platform_02" value="Onsite" <?php if (in_array("Onsite", $newArray)) {
                            ...
                            <div class="col-sm-11"><input type="text" name="up_onsite_location_date" id="up_onsite_location_date" class="form-control" <?php if ($training_request_datas->onsite_location_date == "") { ?> style="display: none;" <?php } ?> value="<?php echo $training_request_datas->onsite_location_date ?>" placeholder="Details for Onsite (if known)"></div>
                        </div>
                    </th>
                </tr> -->
                <tr>
                ...
                <tr>
                    ...
                    <td class="mit border">
                        <!-- <div class="">
                            <textarea class="form-control h-textarea" style="height: 100%;" id="up_trainer_name" name="up_trainer_name"><?php echo $training_request_datas->trainer_name ?></textarea>
                            <label class="">Please fill in Duration (Hr./Day) <span class="red ">*</span></label>
                        </div> -->
                ...
                <tr>
                    <td colspan="3" class="border form_request_head">Is this a course for licensing or certification?<span class="red"> * </span></td>
                ...
                <tr>
                    <td colspan="7">
                        <?php if ($training_request_datas->attachment != "N/A") { ?>
                            ...
                            <a href="<?php echo base_url('index.php/ttc_controller/delete_attachment_formRequest_forMoreinfo/') ?><?php echo $training_request_datas->id ?>/attachment" class="btn btn-danger">Delete File</a>
                        <?php } else {
                            echo "<b>File:</b> N/A";
                        } ?><br>
                ...
                <tr>
                    <td colspan="7" class="form_request_head">More Information</td>
                </tr>
                <tr>
                    <td colspan="7">
                        <div class="">
                ...
                <tr>
                    <td colspan="7" class="form_request_head">Attachment More Information</td>
                </tr>
                <tr>
                    <td colspan="7">
                        <?php if ($training_request_datas->more_attachment != NULL) { ?>
                            ...
                            <a href="<?php echo base_url('index.php/ttc_controller/delete_attachment_formRequest_forMoreinfo/') ?><?php echo $training_request_datas->id ?>/more_attachment" class="btn btn-danger">Delete File</a>
                        <?php } else {
                            echo "<b>File:</b> N/A";
                        } ?><br>
                        <label for="attachment" class="form-label red font-twelve">Attachment file size must not exceed 5MB.</label>
            ...
            <?php } ?>
            <?php if ($training_request_datas->workflow_remark != '') { ?>
                <tr>
...
<div class="container">
    <?php foreach ($training_request_data as $training_request_datas) { ?>
        <table class="table table-form border">
            <tr>
                <th class="text-center form_request_head" colspan="5">
                    <?php if ($training_request_datas->workflow_remark == "Requested More Information by Admin") { ?>
                        Verify More Information by TTC
                    <?php } else if ($training_request_datas->workflow_remark == "Requested More Information by Reviewer") { ?>
                        Verify More Information by Reviewer
                    <?php } else { ?>
                        Verify More Information by Approver
                    <?php } ?>
                </th>
            </tr>
            <tr>
                <td class="border text-center form_request_head_yellow">
                    <?php if ($training_request_datas->workflow_remark == "Requested More Information by Admin") { ?>
                        TTC Name
                    <?php } else if ($training_request_datas->workflow_remark == "Requested More Information by Reviewer") { ?>
                        Reviewer Name
                ...
                <td class="border text-center form_request_head_yellow">Date</td>
            ...
            <tr>
                <td class="mit border">
                    <?php if ($training_request_datas->workflow_remark == "Requested More Information by Admin") {
                        echo $training_request_datas->admin_name;
                    } else if ($training_request_datas->workflow_remark == "Requested More Information by Reviewer") {
                        echo $training_request_datas->reviewer_name;
                    } else {
                        echo $training_request_datas->approve_name;
                    } ?>
                </td>
                <td class="mit border">
                    <?php if ($training_request_datas->workflow_remark == "Requested More Information by Admin") {
                        echo $training_request_datas->admin_position;
                    } else if ($training_request_datas->workflow_remark == "Requested More Information by Reviewer") {
                        echo $training_request_datas->reviewer_position;
                    } else {
                        echo $training_request_datas->approver_position;
                    } ?>
                </td>
                <td class="mit border">
                    <?php if ($training_request_datas->workflow_remark == "Requested More Information by Admin") {
                        ...
                        $dateold_approver = $training_request_datas->approver_date;
                        $datenew_approver = date('d-m-Y h:i A', strtotime($dateold_approver));
                        echo $datenew_approver;
                    } ?>
                </td>
                <td class="border mit">
                    <?php if ($training_request_datas->workflow_remark == "Requested More Information by Admin") {
                        echo $training_request_datas->admin_status;
                    } else if ($training_request_datas->workflow_remark == "Requested More Information by Reviewer") {
                        echo $training_request_datas->reviewer_status;
                    } else {
                        echo $training_request_datas->approve_status;
                    } ?>
                </td>
                <td class="border" style="width: 400px;">
                    <?php if ($training_request_datas->workflow_remark == "Requested More Information by Admin") {
                        echo $training_request_datas->admin_comment;
                    } else if ($training_request_datas->workflow_remark == "Requested More Information by Reviewer") {
                        echo $training_request_datas->reviewer_comment;
                    } else {
                        echo $training_request_datas->approve_comment;
                    } ?>
                </td>
            </tr>
        </table>
