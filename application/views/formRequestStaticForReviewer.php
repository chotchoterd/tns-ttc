...
$i = 0;
$a = 0;
include 'scriptFormRequestStaticForReviewer.php';
    ...
    <form action="" method="post">
        <table class="table table-form border">
            <?php foreach ($training_request_data as $training_request_datas) { ?>
                ...
                <tr class="mit">
                    <th rowspan="5" colspan="5" style="font-size: 45px;" class="border">Training Request For Reviewer</th>
                </tr>
                <tr>
...
<div class="container-fluid mt-3">
    <table class="table table-form border">
        <tr>
            <th class="display-6 text-center form_request_head" colspan="6">Reviewer Review</th>
        </tr>
        <tr>
