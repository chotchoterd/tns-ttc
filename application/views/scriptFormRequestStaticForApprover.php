<script type="text/javascript">
    ...
    function send_up_Approver() {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>index.php/ttc_controller/send_up_Approver_ajax',
            type: 'POST',
            dataType: 'json',
            data: {
                up_id: up_id,
            ...
            success: function(data) {
                Swal.fire({
                    ...
                    window.location = '<?php echo base_url(); ?>index.php/email_alert/email_Approver/' + up_id + '/' + up_status + '';
                });
            }
        });
    }
