<script type="text/javascript">
    ...
    function up_send_submit_Training_Request_Form() {
        ...
        var up_more_information = document.getElementById("up_more_information").value;
        var fileInput_more;
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>index.php/ttc_controller/up_submit_ForMoreInfor_Training_Request_ajax',
            type: 'POST',
            dataType: 'json',
            data: {
                up_id: up_id,
            ...
            success: function(data) {
                Swal.fire({
                    ...
                    window.location = '<?php echo base_url('index.php/email_alert/emailMoreInformationforPending/'); ?>' + up_id;
                });
            }
        });
    }
