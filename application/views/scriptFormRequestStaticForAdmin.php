<script type="text/javascript">
    $(document).ready(function() {
            ...
            if (course_cat != '') {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#up_course_title').append('<option value="" class="mit">- Choose from the list -</option>');
        ...
        $("[name='up_bt_submit']").click(function() {
            ...
            // } 
                ...
                up_send_submit_Training_Request_Form_static_admin();
            }
        });
    });

    function up_send_submit_Training_Request_Form_static_admin() {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>index.php/ttc_controller/up_submit_For_static_admin_Training_Request_ajax',
            type: 'POST',
            dataType: 'json',
            data: {
                up_id: up_id,
            ...
            success: function(data) {
                Swal.fire({
                    title: "Update data " + up_workflow_remark + " successfully",
                    text: "",
                    icon: "success",
                    timer: 1200,
                    ...
                    window.location = '<?php echo base_url('index.php/ttc_controller/formRequestStaticForAdmin/'); ?>' + up_id;
                });
            }
        });
    }
    ...
    function up_addInput() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                // html += "<td class=\"border mit\"><button class=\"btn btn-primary btn_color_df\" type='button' onclick='devareRow(this);'><b>-</b></button></td>"
    ...
    function send_up_Admin_Verify() {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>index.php/ttc_controller/send_up_Admin_Verify_ajax',
            type: 'POST',
            dataType: 'json',
            data: {
                up_id: up_id,
            ...
            success: function(data) {
                Swal.fire({
                    ...
                    window.location = '<?php echo base_url(); ?>index.php/email_alert/email_Admin_Verify/' + up_id + '/' + up_status + '';
                });
            }
        });
    }
