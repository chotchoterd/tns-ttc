    ...
    <form action="" method="post">
        <table class="table table-form border">
            <?php foreach ($training_request_data as $training_request_datas) { ?>
                ...
                <tr class="mit">
                    <th rowspan="5" colspan="5" style="font-size: 50px;" class="border">Training Request <?php if ($training_request_datas->status == 0) echo "(Cancel)" ?></th>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="3" class="mit form_request_head border">Course Category</td>
                    <td colspan="3" class="mit form_request_head border">Course Title</td>
                ...
                <tr>
                    ...
                    <td colspan="2" class="border mit-v">
                        <table class="table">
                            <tr>
                                <td>
                ...
                <tr>
                    <td class="form_request_head border mit" colspan="2">Attendee Name</td>
                    ...
                    <td class="form_request_head border mit">Division</td>
...
<?php foreach ($training_request_data as $training_request_datas) {
    if ($training_request_datas->admin_status != "Pending") { ?>
        <div class="container">
            <table class="table table-form border">
                <tr>
                ...
                <tr>
                    ...
                    <td class="border text-center form_request_head_yellow">Admin Position</td>
                ...
                <tr>
                    ...
                    <td class="border mit"><?php echo $training_request_datas->admin_position ?></td>
                    <td class="border mit">
                        <?php
    ...
    <?php } else if ($training_request_datas->status == 1) { ?>
        <div class="container">
            <table class="table table-form border">
                <tr>
                    <b>Next Step....</b>
                    <td class=" text-center form_request_head">
                        Verify by TTC
                    </td>
                </tr>
            </table>
    ...
    <?php } ?>
    <?php if ($training_request_datas->reviewer_status != "Pending") { ?>
        <div class="container mt-3">
            <table class="table table-form border">
                ...
                <tr>
                    ...
                    <td class="border text-center form_request_head_yellow">Reviewer Position</td>
                    <td class="border text-center form_request_head_yellow">Finished Date</td>
                    <td class="border text-center form_request_head_yellow">Status</td>
                    <td class="border text-center form_request_head_yellow">Comment</td>
                </tr>
                <tr>
                    ...
                    <td class="border mit"><?php echo $training_request_datas->reviewer_position ?></td>
                    <td class="border mit">
                        <?php
    ...
    <?php } else if ($training_request_datas->reviewer_status == "Pending" && $training_request_datas->admin_status == "Approved" && $training_request_datas->status == 1) { ?>
        <div class="container">
            <table class="table table-form border">
                <tr>
                    <b>Next Step....</b>
                    <th class=" text-center form_request_head" colspan="3">
                        Review by Reviewer
                    </th>
                </tr>
                <tr>
                    <td class="border text-center form_request_head_yellow">Reviewer Name</td>
                    <td class="border text-center form_request_head_yellow">E-Mail</td>
                    <td class="border text-center form_request_head_yellow">Status</td>
                </tr>
                <tr>
                    <td class="border mit"><?php echo $training_request_datas->reviewer_name ?></td>
                    <td class="border mit"><?php echo $training_request_datas->reviewer_email ?></td>
                    <td class="border mit">Waiting</td>
                </tr>
            </table>
        </div>
    <?php } ?>
    <?php if ($training_request_datas->approve_status != "Pending") { ?>
        <div class="container mt-3">
            <table class="table table-form border">
                <tr>
                    <th class=" text-center form_request_head" colspan="5">
                ...
                <tr>
                    <td class="border text-center form_request_head_yellow">Approver Name</td>
                    <td class="border text-center form_request_head_yellow">Approver Position</td>
                    <td class="border text-center form_request_head_yellow">Finished Date</td>
                    <td class="border text-center form_request_head_yellow">Status</td>
                    <td class="border text-center form_request_head_yellow">Comment</td>
                </tr>
                <tr>
                    <td class="border mit"><?php echo $training_request_datas->approve_name ?></td>
                    <td class="border mit"><?php echo $training_request_datas->approver_position ?></td>
                    <td class="border mit">
                        <?php
                        $dateold_approve = $training_request_datas->approver_date;
                        $datenew_approve = date('d/m/Y h:i A', strtotime($dateold_approve));
                        echo $datenew_approve; ?>
                    </td>
                    <td class="border mit"><?php echo $training_request_datas->approve_status ?></td>
                    <td class="border" style="width: 400px;"><?php echo $training_request_datas->approve_comment ?></td>
                </tr>
            </table>
        </div>
    <?php } else if ($training_request_datas->approve_status == "Pending" && $training_request_datas->reviewer_status == "Approved" && $training_request_datas->admin_status == "Approved" && $training_request_datas->status == 1) { ?>
        <div class="container">
            <table class="table table-form border">
                <tr>
                    <b>Next Step....</b>
                ...
                <tr>
                    <td class="border mit"><?php echo $training_request_datas->approve_name ?></td>
                    <td class="border mit"><?php echo $training_request_datas->approve_email ?></td>
                    <td class="border mit">Waiting</td>
                </tr>
            </table>
        </div>
