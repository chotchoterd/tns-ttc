...
include 'scriptFormRequestForReject.php';
?>
            ...
            <?php foreach ($training_request_data as $training_request_datas) { ?>
                ...
                <tr class="mit">
                    <th rowspan="5" colspan="5" style="font-size: 50px;" class="border">
                        <?php if ($training_request_datas->workflow_remark == "Rejected by Admin") { ?>
                            Training Request<br>(Rejected by Admin)
                        <?php } else if ($training_request_datas->workflow_remark == "Rejected by Reviewer") { ?>
                            Training Request<br>(Rejected by Reviewer)
                        <?php } else { ?>
                            Training Request<br>(Rejected by Approver)
                        <?php } ?>
                    </th>
                </tr>
                <tr>
                        ...
                        <table>
                            <tr>
                                <td class="px-2">
                                    ...
                                    <select name="up_section_code" id="up_section_code" class="form-select" aria-label="Default select example" <?php if ($training_request_datas->workflow_remark == "Rejected by Reviewer" || $training_request_datas->workflow_remark == "Rejected by Approver") echo "disabled"; ?>>
                ...
                <tr>
                    <td colspan="7">
                        <?php if ($training_request_datas->attachment != "N/A") { ?>
                            ...
                            <a href="<?php echo base_url('index.php/ttc_controller/delete_attachment_formRequest_forReject/') ?><?php echo $training_request_datas->id ?>/attachment" class="btn btn-danger">Delete File</a>
                        <?php } else {
                            echo "<b>File:</b> N/A";
                        } ?><br>
                ...
                <tr <?php if ($training_request_datas->more_comment == "" && $training_request_datas->more_attachment == NULL) echo "style=\"display: none;\""; ?>>
                    <td colspan="7">
                        <?php if ($training_request_datas->more_attachment != NULL) { ?>
                            ...
                            <a href="<?php echo base_url('index.php/ttc_controller/delete_attachment_formRequest_forReject/') ?><?php echo $training_request_datas->id ?>/more_attachment" class="btn btn-danger">Delete File</a>
                        <?php } else {
                            echo "<b>File:</b> N/A";
                        } ?><br>
                        <label for="attachment" class="form-label red font-twelve">Attachment file size must not exceed 5MB.</label>
        ...
        <table class="table table-form border">
            <tr>
                <th class="text-center form_request_head" colspan="5">
                    <?php if ($training_request_datas->workflow_remark == "Rejected by Admin") { ?>
                        Verify Reject by TTC
                    <?php } else if ($training_request_datas->workflow_remark == "Rejected by Reviewer") { ?>
                        Verify Reject by Reviewer
                    <?php } else { ?>
                        Verify Reject by Approver
                    <?php } ?>
                </th>
            </tr>
            <tr>
            ...
            <tr>
                <td class="mit border">
                    ...
                    } else if ($training_request_datas->workflow_remark == "Rejected by Reviewer") {
